...
dfDeathsCountriesDifference = \
    dfDeathsCountriesSorted.sort_values(by=dfDeathsCountriesSorted.columns[-1], ascending=False)[
        ['Country/Region', dfDeathsCountriesSorted.columns[-1]]][0:10]
...
dfConfirmedCountriesSorted['Difference'] = dfConfirmedCountriesSorted.iloc[:, -1] - dfConfirmedCountriesSorted.iloc[:,
                                                                                    -3]
dfConfirmedCountriesCurrent = dfConfirmedCountriesSorted[['Country/Region', dfConfirmedCountriesSorted.columns[-2]]][
                              0:10]
dfConfirmedCountriesDifference = \
    dfConfirmedCountriesSorted.sort_values(by=dfConfirmedCountriesSorted.columns[-1], ascending=False)[
        ['Country/Region', dfConfirmedCountriesSorted.columns[-1]]][0:10]
...
dfRecoveredCountriesSorted['Difference'] = dfRecoveredCountriesSorted.iloc[:, -1] - dfRecoveredCountriesSorted.iloc[:,
                                                                                    -3]
dfRecoveredCountriesCurrent = dfRecoveredCountriesSorted[['Country/Region', dfRecoveredCountriesSorted.columns[-2]]][
                              0:10]
dfRecoveredCountriesDifference = \
    dfRecoveredCountriesSorted.sort_values(by=dfRecoveredCountriesSorted.columns[-1], ascending=False)[
        ['Country/Region', dfRecoveredCountriesSorted.columns[-1]]][0:10]
...
# Top 10 Country time series data - confirmed
...
# Top 10 Country time series data - deaths
dfDeathsCountriesSortedTop10TimeSeries = dfDeathsCountriesSorted.iloc[0:10, 1]
dfDeathsCountriesSortedTop10TimeSeriesSum = dfDeathsCountriesSorted.iloc[0:10, 4:-2]
dfDeathsCountriesSortedTop10TimeSeriesSum["Countries"] = dfDeathsCountriesSortedTop10TimeSeries
...
globaltimeseries = location.copy()
